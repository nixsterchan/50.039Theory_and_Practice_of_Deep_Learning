...
def test_parseclasslabel(jpeg_path):
  filen='data/imagenet/synset_words.txt'

  # remove .jpeg and replace with .xml
  xml_path = jpeg_path.replace('.JPEG', '.xml')

  nm= f'data/imagenet/ILSVRC2012_bbox_val_v3/val/{xml_path}'
